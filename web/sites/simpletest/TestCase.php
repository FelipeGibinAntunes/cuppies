        ...
        if ($this->runInSeparateProcess()) {
            ...
            if ($runEntireClass) {
                $template = new Template(
                    'D:\wamp64\www\cuppies\vendor\composer/../phpunit/phpunit/src/Util/PHP/Template/TestCaseClass.tpl',
                );
            } else {
                $template = new Template(
                    'D:\wamp64\www\cuppies\vendor\composer/../phpunit/phpunit/src/Util/PHP/Template/TestCaseMethod.tpl',
                );
            }
