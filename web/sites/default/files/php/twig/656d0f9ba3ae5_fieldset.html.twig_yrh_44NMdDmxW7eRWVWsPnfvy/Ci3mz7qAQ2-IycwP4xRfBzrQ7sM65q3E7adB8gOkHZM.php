...
class __TwigTemplate_ec33c13faccce2dfe4c2e6909db18b44 extends Template
{
    private $source;
    private $macros = [];
...
($context["required"] ?? null)) ? ("form-required") : (""))];
  ...
  <div class=\"fieldset-wrapper\">
    ...
    ";
        ...
        // line 70
        echo "    ";
        if ((twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "id", [], "any", false, false, true, 70) == "edit-field-tags-target-id--wrapper")) {
            // line 71
            echo "      <button class=\"clear-filters\" onclick=\"window.location='main'\" type=\"button\">Clear Filters</button>  
    ";
        }
        // line 73
        echo "  </div>
...
";
    ...
    {
        return array (  127 => 73,  123 => 71,  120 => 70,  112 => 68,  109 => 67,  103 => 65,  101 => 64,  96 => 63,  90 => 61,  87 => 60,  81 => 57,  78 => 56,  75 => 55,  67 => 53,  65 => 52,  57 => 49,  52 => 48,  50 => 47,  48 => 44,  47 => 43,  46 => 41,  41 => 39,  39 => 32,);
    }
...
<fieldset{{ attributes.addClass(classes) }}>
  ...
  <div class=\"fieldset-wrapper\">
    ...
    {% if description_display in ['after', 'invisible'] and description.content %}
      <div{{ description.attributes.addClass('description') }}>{{ description.content }}</div>
    {% endif %}
    {% if attributes.id == 'edit-field-tags-target-id--wrapper' %}
      <button class=\"clear-filters\" onclick=\"window.location='main'\" type=\"button\">Clear Filters</button>  
    {% endif %}
  </div>
</fieldset>
", "core/modules/system/templates/fieldset.html.twig", "D:\\wamp64\\www\\cuppies\\web\\core\\modules\\system\\templates\\fieldset.html.twig");
    }
