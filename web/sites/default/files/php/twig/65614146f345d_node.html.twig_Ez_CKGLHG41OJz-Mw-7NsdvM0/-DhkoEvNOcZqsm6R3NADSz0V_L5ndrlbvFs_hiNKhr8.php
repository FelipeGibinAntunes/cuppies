...
class __TwigTemplate_ae860f0807d8fc27c424c12480032721 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 73
        if ((($context["isProduct"] ?? null) || ($context["isCart"] ?? null))) {
            // line 74
  ...
  <div";
    ...
    ";
        ...
        if (($context["isProduct"] ?? null)) {
            // line 100
            echo "      ";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["ProductForm"] ?? null), 100, $this->source), "html", null, true);
            echo "
    ";
        }
        // line 102
    ...
    ";
        ...
        if (($context["isCart"] ?? null)) {
            // line 104
            echo "    ";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["CartForm"] ?? null), 104, $this->source), "html", null, true);
            echo "
    ";
        }
        // line 106
...
";
    ...
    {
        return array (  134 => 106,  128 => 104,  126 => 103,  123 => 102,  117 => 100,  115 => 99,  109 => 96,  105 => 95,  102 => 94,  94 => 90,  92 => 89,  88 => 88,  84 => 87,  81 => 86,  79 => 85,  73 => 83,  65 => 80,  60 => 79,  58 => 78,  54 => 77,  51 => 76,  47 => 74,  45 => 73,  39 => 71,);
    }
...
", "themes/custom/cuppies_theme/templates/node.html.twig", "D:\\wamp64\\www\\cuppies\\web\\themes\\custom\\cuppies_theme\\templates\\node.html.twig");
    ...
    {
        static $tags = array("if" => 73, "trans" => 89);
